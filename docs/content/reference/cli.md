...
```
bioproject <command> [arguments] [flags]
```

Run `bioproject <command> --help` for the full flag list on any command. This
...
per operation you declare in `bioproject/domain.go`.
