...
Most of these come down to network reality or how bioproject serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

bioproject rate-limits like any public site. bioproject already paces
...
Where a surface is gated, bioproject reads a cookie or token you supply
...
`bioproject`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what bioproject actually did
