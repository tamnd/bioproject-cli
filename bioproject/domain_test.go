...
// HTTP behaviour is covered in bioproject_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "bioproject://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("bioproject", "about")
	if err != nil || got.String() != "bioproject://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want bioproject://page/about", got.String(), err)
	}
}
